...
public class Tile {
	...
	private int x;
	private int y;
	public static boolean imm=false;
	...
	private void drawImage() {
		...
		if ((value == 2 & !imm) || value == 1) {
			background = new Color(0xe9e9e9);
			text = new Color(0x000000);
		}
		else if (value == 4 || (value == 2 & imm)) {
			background = new Color(0xe6daab);
			text = new Color(0x000000);
		}
		else if ((value == 8  & !imm) || value == 3) {
			background = new Color(0xf79d3d);
			text = new Color(0xffffff);
		}
		else if (value == 16 || value == 5) {
			background = new Color(0xf28007);
			text = new Color(0xffffff);
		}
		else if (value == 32 || (value == 8  & imm)) {
			background = new Color(0xf55e3b);
			text = new Color(0xffffff);
		}
		else if (value == 64 || value == 13) {
			background = new Color(0xff0000);
			text = new Color(0xffffff);
		}
		else if (value == 128 || value == 21) {
			background = new Color(0xe9de84);
			text = new Color(0xffffff);
		}
		else if (value == 256 || value == 34) {
			background = new Color(0xf6e873);
			text = new Color(0xffffff);
		}
		else if (value == 512 || value == 55) {
			background = new Color(0xf5e455);
			text = new Color(0xffffff);
		}
		else if (value == 1024 || value == 89) {
			background = new Color(0xf7e12c);
			text = new Color(0xffffff);
		}
		else if (value == 2048 || value == 144) {
